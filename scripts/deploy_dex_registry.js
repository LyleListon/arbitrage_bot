...
async function main() {
    ...
    try {
        ...
        for (const [baseToken, quoteToken] of pairs) {
            ...
            console.log("Pair added to factory successfully!");
            ...
            console.log("Pair added to router successfully!");
        }
        ...
        console.log("WETH-USDC pair supported on factory:", isFactoryPairSupported);
        ...
        console.log("WETH-USDC pair supported on router:", isRouterPairSupported);

        // Update config.yaml with new DEXRegistry address
        console.log("\nDon't forget to update config.yaml with the new DEXRegistry address:", dexRegistry.address);

    } catch (error) {
        console.error("\nError deploying/registering DEXes:", error.message);
