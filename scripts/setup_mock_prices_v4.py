...
def send_transaction(w3, contract_function, account, gas=200000):
    ...
    # Sign transaction
    signed = eth_account.Account.sign_transaction(transaction, account.key)
