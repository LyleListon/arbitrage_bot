...
async function main() {
    console.log("Updating DEX Registry...");
    ...
    try {
        ...
        // First deactivate any existing registration
        console.log("\nDeactivating existing registration...");
        try {
            await dexRegistry.deactivateDEX(uniswapV3Factory);
            console.log("Existing registration deactivated!");
        } catch (error) {
            console.log("No existing registration to deactivate");
        }
        ...
        const info = await dexRegistry.getDEXInfo(uniswapV3Factory);
        console.log(`Factory ${uniswapV3Factory}:`, {
            protocol: info[0],
        ...
        console.error("\nError updating DEX Registry:", error.message);
